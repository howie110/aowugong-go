...
const frame = { width: 480, height: 104, left: 30, right: 470, top: 8, bottom: 72 };
...
export function SignalNetTrend({ points }: { points: SignalNetPoint[] }) {
  const chart = useMemo(() => buildSignalNetChart(points), [points]);
  ...
  return (
    <svg
      ...
      className="block h-24 w-[30rem] max-w-full touch-none select-none"
      role="img"
...
function buildSignalNetChart(points: SignalNetPoint[]) {
